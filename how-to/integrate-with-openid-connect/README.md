...
3. Optional (if you wish to pin the version of OpenFin Workspace to version 17.4.0 and you are on Windows) - Set Windows registry key for [Desktop Owner Settings](https://developers.openfin.co/docs/desktop-owner-settings).
