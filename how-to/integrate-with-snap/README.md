...
- [Live Launch Classic Example](https://start.openfin.co/?manifest=https%3A%2F%2Fbuilt-on-openfin.github.io%2Fworkspace-starter%2Fworkspace%2Fv22.0.0%2Fintegrate-with-snap%2Fsecond.manifest.fin.json)
...
```json
  "preloadScripts": [{ "url": "https://built-on-openfin.github.io/workspace-starter/workspace/v22.0.0/integrate-with-snap/js/snap.preload.bundle.js" }],
```

If you want the debug version with the debug window automatically showing then you can reference this preload script:

```json
  "preloadScripts": [{ "url": "https://built-on-openfin.github.io/workspace-starter/workspace/v22.0.0/integrate-with-snap/js/snap.preload.debug.bundle.js" }],
```
...
```json
  "preloadScripts": [{ "url": "https://built-on-openfin.github.io/workspace-starter/workspace/v22.0.0/integrate-with-snap/js/snap.preload.channel.bundle.js" }],
```
