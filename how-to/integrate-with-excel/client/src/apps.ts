...
const FDC3_BROADCAST: App = {
	...
	manifest:
		"https://built-on-openfin.github.io/dev-extensions/extensions/v21.0.0/interop/fdc3/context/fdc3-broadcast-view.json",
	manifestType: "view",
	icons: [
		{
			src: "http://localhost:8080/common/images/icon-blue.png"
...
const INTEROP_BROADCAST: App = {
	...
	manifest:
		"https://built-on-openfin.github.io/dev-extensions/extensions/v21.0.0/interop/interop-api/context/interop-broadcast-view.json",
	manifestType: "view",
	icons: [
		{
			src: "http://localhost:8080/common/images/icon-blue.png"
