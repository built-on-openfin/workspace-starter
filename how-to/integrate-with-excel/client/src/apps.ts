...
const FDC3_BROADCAST: App = {
	...
	manifest:
		"https://built-on-openfin.github.io/dev-extensions/extensions/v16.0.0/interop/fdc3/context/fdc3-broadcast-view.json",
	manifestType: "view",
	icons: [
		{
			src: "http://localhost:8080/common/images/icon-blue.png"
	...
	images: [
		{
			src: "https://built-on-openfin.github.io/dev-extensions/extensions/v16.0.0/interop/images/previews/view-context-fdc3.png"
		}
	],
...
const INTEROP_BROADCAST: App = {
	...
	manifest:
		"https://built-on-openfin.github.io/dev-extensions/extensions/v16.0.0/interop/interop-api/context/interop-broadcast-view.json",
	manifestType: "view",
	icons: [
		{
			src: "http://localhost:8080/common/images/icon-blue.png"
	...
	images: [
		{
			src: "https://built-on-openfin.github.io/dev-extensions/extensions/v16.0.0/interop/images/previews/view-context-interop-api.png"
		}
	],
