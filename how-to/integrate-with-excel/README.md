<img src="../../assets/OpenFin-Workspace-Starter.png" width="100%" alt="OpenFin Workspace Example Application -- Integrate with Excel" />
...
* Launch the Github hosted version of this sample to interact with it by going to the following link: <a href="https://start.openfin.co/?manifest=https%3A%2F%2Fbuilt-on-openfin.github.io%2Fworkspace-starter%2Fworkspace%2Fv7.0.0%2Fintegrate-with-excel%2Fmanifest.fin.json" target="_blank">Github Workspace Starter Integrate with Excel</a>
...
6. You can use the custom command in the search box `/excel` which will provide a list of workbooks that can be opened. Follow the instructions in the workbooks to see their functionality in action.
