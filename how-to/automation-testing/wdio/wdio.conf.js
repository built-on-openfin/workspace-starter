...
// e.g. if the manifest runtime version is 41.134.100.115 then the chromedriver version should be '126.0.0'
const manifestUrl =
	'https://built-on-openfin.github.io/workspace-starter/workspace/v21.0.0/register-with-home/manifest.fin.json';
