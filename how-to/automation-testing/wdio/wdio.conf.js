...
// e.g. if the manifest runtime version is 30.110.74.16 then the chromedriver version should be '110.0.0'
const manifestUrl =
	'https://built-on-openfin.github.io/workspace-starter/workspace/v12.6.0/register-with-home/manifest.fin.json';
