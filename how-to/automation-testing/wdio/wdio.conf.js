...
// e.g. if the manifest runtime version is 32.114.76.14 then the chromedriver version should be '114.0.0'
const manifestUrl =
	'https://built-on-openfin.github.io/workspace-starter/workspace/v15.0.0/register-with-home/manifest.fin.json';
