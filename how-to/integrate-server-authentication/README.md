![HERE Core UI Example Application -- Integrate Server Authentication](../../assets/HERO-STARTER-HERE-CORE-UI.png)
...
Your HERE application will often need to authenticate using a server login page before use, this examples demonstrates such an integration.
