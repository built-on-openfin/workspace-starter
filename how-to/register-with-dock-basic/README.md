...
HERE Core UI empowers you to take advantage of our dock component by using our HERE Core UI Platform SDK to control the behavior of the HERE Dock independent of the Home and Storefront components. This example shows how to do a few basic things such as:
...
- Launch the Github hosted version of this sample to interact with it by going to the following link: [Github Workspace Starter Register With Dock Basic](https://start.openfin.co/?manifest=https%3A%2F%2Fbuilt-on-openfin.github.io%2Fworkspace-starter%2Fworkspace%2Fv45.0.0%2Fregister-with-dock-basic%2Fmanifest.fin.json)
