...
export const themeBuilderApp: App = {
	...
	manifest:
		"https://samples.openfin.co/dev-extensions/extensions/v9.1.0/branding/theme-definition-builder/theme-definition-builder-view.json",
	manifestType: "view",
	...
	images: [
		{
			src: "https://samples.openfin.co/dev-extensions/extensions/v9.1.0/branding/images/previews/theme-definition-builder.png"
		}
	],
