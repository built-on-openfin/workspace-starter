...
This sample is an extension of the support context and intents. The sample covers:
...
* Installing and configuring the Native Window Integration.
* Extending your snapshots to include Native Windows 
...
8. TODO: We need to pick a better native window app for the example, I went with Symphony.

# TODO: Everything below this will be changed: 
