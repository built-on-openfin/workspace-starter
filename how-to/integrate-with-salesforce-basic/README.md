...
HERE Core UI empowers you to use our integration packages to connect to 3rd party data sources, such as Salesforce.
...
For more information on the Salesforce integration package and how you should configure your Salesforce platform to be accessible from the HERE integration package see [Salesforce Integration](https://developers.openfin.co/of-docs/docs/salesforce-integration).
