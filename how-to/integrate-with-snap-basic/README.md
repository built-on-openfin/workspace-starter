...
2. Optional (if you wish to pin the version of OpenFin Workspace to version 15.0.8 and you are on Windows) - Set Windows registry key for [Desktop Owner Settings](https://developers.openfin.co/docs/desktop-owner-settings).
