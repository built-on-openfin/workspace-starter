 ...
 */
export type LifecycleEvents = "auth-logged-in" | "auth-session-expired" | "auth-before-logged-out" | "after-bootstrap" | "before-quit" | "theme-changed" | "workspace-changed" | "page-changed" | "apps-changed" | "app-asset-download" | "favorite-changed" | "condition-changed" | "language-changed";
/**
