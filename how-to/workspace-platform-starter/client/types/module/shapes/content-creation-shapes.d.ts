 ...
 */
export type ContentCreationEvent<T extends OpenFin.Events.WebContentsEvents.ContentCreationRulesEvent> = Omit<T, "type"> & {
...
export interface ContentCreationRules<O = unknown, H = ModuleHelpers> extends ModuleImplementation<O, H> {
     ...
     */
    handleViewCreated?(platform: WorkspacePlatformModule, event: ContentCreationEvent<OpenFin.Events.WebContentsEvents.ChildViewCreatedEvent>, matchingRuleIndex: number, attached: boolean): Promise<boolean>;
    /**
     ...
     * @returns Nothing.
     */
    handleWindowCreated?(platform: WorkspacePlatformModule, event: ContentCreationEvent<OpenFin.Events.WebContentsEvents.ChildWindowCreatedEvent>, matchingRuleIndex: number): Promise<void>;
    /**
     ...
     * @returns Nothing.
     */
    handleBrowserCreated?(platform: WorkspacePlatformModule, event: ContentCreationEvent<OpenFin.Events.WebContentsEvents.ChildContentOpenedInBrowserEvent>, matchingRuleIndex: number): Promise<void>;
    /**
     ...
     * @returns Nothing.
     */
    handleBlocked?(platform: WorkspacePlatformModule, event: ContentCreationEvent<OpenFin.Events.WebContentsEvents.ChildContentBlockedEvent>, matchingRuleIndex: number): Promise<void>;
}
