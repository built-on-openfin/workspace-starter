import type { BrowserInitConfig, GlobalContextMenuOptionType, PageTabContextMenuOptionType, ToolbarButton, ViewTabMenuOptionType } from "@openfin/workspace-platform";
 ...
 */
export type BrowserProviderOptions = Pick<BrowserInitConfig, "defaultWindowOptions" | "defaultPageOptions" | "defaultViewOptions" | "title"> & {
    /**
