...
import type { NotificationsPlatform, create, getAll, clear, clearAll, update, show, hide, NotificationCreatedEvent, NotificationActionEvent, NotificationFormSubmittedEvent, NotificationToastDismissedEvent, NotificationClosedEvent, NotificationReminderCreatedEvent, NotificationReminderRemovedEvent, NotificationsCountChanged, UpdatableNotificationOptions, NotificationOptions } from "@openfin/workspace/notifications";
/**
...
export interface NotificationClient {
     ...
     * @returns nothing.
     */
    addEventListener<K extends keyof NotificationsEventMap>(eventType: K, listener: (event: NotificationsEventMap[K]) => void): Promise<void>;
    /**
     ...
     * @returns nothing.
     */
    removeEventListener<K extends keyof NotificationsEventMap>(eventType: K, listener: (event: NotificationsEventMap[K]) => void): Promise<void>;
}
/**
 ...
 */
export type NotificationSourceEvents = NotificationSourceCreateEvent | NotificationSourceUpdateEvent | NotificationSourceClearEvent | NotificationSourceCloseEvent;
