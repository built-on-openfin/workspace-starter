...
export type PlatformApp = App & {
     ...
     */
    manifest: string | Partial<OpenFin.ViewOptions> | Partial<OpenFin.WindowOptions> | Partial<OpenFin.Snapshot> | Partial<OpenFin.ExternalProcessRequestType> | Partial<OpenFin.AppAssetInfo>;
    /**
 ...
 */
export type UpdatableLaunchPreferenceDefinition = WindowPreference | WindowPreferenceUrl | ViewPreference | ViewPreferenceUrl | NativePreference;
/**
