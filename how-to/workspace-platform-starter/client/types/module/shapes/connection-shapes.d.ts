 ...
 */
export type ConnectionTypes = AppSourceConnection | SnapshotSourceConnection | ActionConnection | BrokerConnection;
/**
...
export interface ConnectionClient {
     ...
     */
    isConnectionValid<T>(identity: OpenFin.Identity, payload?: unknown, options?: ConnectionValidationOptions<T>): Promise<ConnectionValidationResponse>;
}
/**
 * Provides an interface for modules that need to use functions
 * that take into account internal and possible external connections
...
export interface PlatformConnectionClient extends ConnectionClient {
     ...
     */
    applyClientSnapshot?(snapshot: OpenFin.Snapshot & {
