...
export interface ButtonClient {
     ...
     */
    getToolbarButtons(windowCreateOptions?: OpenFin.PlatformWindowCreationOptions): Promise<ToolbarButton[] | undefined>;
    /**
     ...
     */
    updateToolbarButtons(buttons: ToolbarButton[], buttonId: string, replacementButtonId: string): Promise<ToolbarButton[]>;
    /**
