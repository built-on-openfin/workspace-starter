 ...
 */
export type ConditionContextTypes = ConditionContextDock | ConditionContextBrowser | ConditionContextMenu | ConditionContextInitOptions;
/**
 * Callback that a condition must implement.
 */
export type ConditionCallback = (platform: WorkspacePlatformModule, context?: ConditionContextTypes) => Promise<boolean>;
/**
