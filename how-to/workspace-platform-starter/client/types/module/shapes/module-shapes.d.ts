...
export interface ModuleHelpers {
     ...
     */
    launchPage?(page: Page, options?: {
        bounds?: OpenFin.Bounds;
        targetWindowIdentity?: OpenFin.Identity;
        createCopyIfExists?: boolean;
    }, logger?: Logger): Promise<BrowserWindowModule>;
    /**
     ...
     */
    showPopupMenu?<T = unknown>(position: {
        x: number;
        y: number;
    }, parentIdentity: OpenFin.Identity, noEntryText: string, menuEntries: {
        label: string;
        customData: T;
        icon?: string;
    }[], options?: {
 ...
 */
export type ModuleTypes = "actions" | "auth" | "endpoint" | "log" | "initOptions" | "integrations" | "conditions" | "lifecycle" | "analytics" | "menus";
/**
