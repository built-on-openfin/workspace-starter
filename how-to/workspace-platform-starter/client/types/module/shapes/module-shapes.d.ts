...
export interface ModuleHelpers {
     ...
     */
    launchApp?(appId: string, launchPreference?: UpdatableLaunchPreference, callerIdentity?: OpenFin.Identity): Promise<PlatformAppIdentifier[] | undefined>;
    /**
     ...
     */
    launchPage?(pageId: string, options?: {
        bounds?: OpenFin.Bounds;
        targetWindowIdentity?: OpenFin.Identity;
        createCopyIfExists?: boolean;
    }, logger?: Logger): Promise<BrowserWindowModule | undefined>;
    /**
     * Launch a workspace.
     ...
     */
    launchView?(view: OpenFin.PlatformViewCreationOptions | string, targetIdentity?: OpenFin.Identity): Promise<OpenFin.View>;
    /**
     * Launch a snapshot.
     ...
     */
    subscribeLifecycleEvent?<T = unknown>(lifecycleEvent: LifecycleEvents, lifecycleHandler: LifecycleHandler<T>): string;
    /**
 ...
 */
export type ModuleTypes = "actions" | "auth" | "endpoint" | "log" | "initOptions" | "integrations" | "conditions" | "lifecycle" | "analytics" | "menus" | "contentCreation" | "share" | "interopOverride" | "platformOverride";
/**
 ...
 * Module entry.
 */
export interface ModuleEntry<M extends ModuleImplementation<O, H> = ModuleImplementation<unknown, unknown>, H = ModuleHelpers, O = unknown, D extends ModuleDefinition<O> = ModuleDefinition<O>> {
    /**
