...
export interface ShareClient {
     ...
     * @returns Nothing.
     */
    confirmation(confirmationOptions: ShareConfirmationOptions, confirmationType: ShareConfirmationType | undefined, parentIdentity?: OpenFin.Identity): Promise<void>;
}
