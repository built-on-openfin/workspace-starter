...
export interface DockButtonDropdown extends DockButtonBase {
     ...
     */
    options: (Omit<DockButtonAppsByTag, "id"> | Omit<DockButtonApp, "id"> | Omit<DockButtonAction, "id"> | Omit<DockButtonDropdown, "id">)[];
    /**
...
export interface DockClient {
     ...
     */
    loadConfig(id: string, defaultStorage: (id: string) => Promise<DockProviderConfigWithIdentity | undefined>): Promise<DockProviderConfigWithIdentity | undefined>;
    /**
     ...
     * @returns nothing
     */
    saveConfig(config: DockProviderConfigWithIdentity, defaultStorage: (config: DockProviderConfigWithIdentity) => Promise<void>): Promise<void>;
}
/**
...
export interface DockImplementation {
     ...
     */
    register(options: DockProviderOptions, bootstrapOptions: BootstrapOptions | undefined): Promise<DockProviderRegistration | undefined>;
    /**
