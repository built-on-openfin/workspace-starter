...
export interface MenuClient {
    ...
    showPopupMenu<T = unknown>(position: {
        x: number;
        y: number;
    }, parentIdentity: OpenFin.Identity, noEntryText: string, menuEntries: PopupMenuEntry<T>[], options?: {
        popupMenuStyle?: PopupMenuStyles;
    }): Promise<T | undefined>;
}
/**
...
export interface PlatformMenuClient extends MenuClient {
     ...
     */
    getGlobalMenu: (defaultGlobalContextMenu?: GlobalContextMenuItemTemplate[], relatedMenuId?: RelatedMenuId) => Promise<GlobalContextMenuItemTemplate[]>;
    /**
     * Gets the page menu.
     */
    getPageMenu: (defaultPageContextMenu: PageTabContextMenuItemTemplate[], relatedMenuId?: RelatedMenuId) => Promise<PageTabContextMenuItemTemplate[]>;
    /**
     * Gets the view menu.
     */
    getViewMenu: (defaultViewContextMenu: ViewTabContextMenuTemplate[], relatedMenuId?: RelatedMenuId) => Promise<ViewTabContextMenuTemplate[]>;
}
