...
import type { CustomActionSpecifier, GlobalContextMenuItemTemplate, GlobalContextMenuOptionType, PageTabContextMenuItemTemplate, PageTabContextMenuOptionType, ViewTabContextMenuTemplate, ViewTabMenuOptionType, WorkspacePlatformModule } from "@openfin/workspace-platform";
 ...
 */
export type MenuTemplateType = GlobalContextMenuItemTemplate | PageTabContextMenuItemTemplate | ViewTabContextMenuTemplate;
/**
 * Which options belong to each menu type.
 */
export type MenuOptionType<T> = T extends GlobalContextMenuItemTemplate ? GlobalContextMenuOptionType : T extends PageTabContextMenuItemTemplate ? PageTabContextMenuOptionType : ViewTabMenuOptionType;
