...
interface UtilsPosition {
     ...
     */
    centerContentInIdentity(clientIdentity: OpenFin.Identity, dimensions: {
        width: number;
        height: number;
    }): Promise<{
        x: number;
     ...
     */
    centerContentInRect(availableRect: {
        left: number;
        top: number;
        right: number;
        bottom: number;
     ...
     */
    findMonitorContainingPoint(point: {
        x?: number;
        y?: number;
     ...
     */
    getWindowPositionUsingStrategy(windowPositioningOptions?: WindowPositioningOptions, relatedTo?: OpenFin.MonitorDetails | OpenFin.Identity | {
        x: number;
        y: number;
    }): Promise<{
        left: number;
