 ...
 */
export class InitOptionsLaunchWorkspaceHandler implements InitOptionsHandler<LaunchWorkspaceOptions> {
	 ...
	 */
	public async action(requestedAction: string, payload?: LaunchWorkspacePayload): Promise<void> {
		if (isEmpty(payload)) {
			this._logger?.warn(
