...
export interface StorefrontSettingsNavigationItem {
	...
	title: string;
	/**
	 * The Storefront API has a collection of apps for a navigation item. Tags is an approach for how you can determine what apps should be included in a navigation item.
