...
interface UtilsPosition {
     ...
     */
    centerContentInIdentity(clientIdentity: OpenFin.Identity,
        dimensions: { width: number; height: number }): Promise<{ x: number; y: number } | undefined>;
    /**
     ...
     */
    centerContentInRect(availableRect: { left: number; top: number; right: number; bottom: number },
        contentDimensions: { width: number; height: number }): { x: number; y: number };
    /**
     ...
     */
    pointInRect(point: { x: number; y: number },
        rect: { top: number; left: number; bottom: number; right: number }): boolean;
    /**
     ...
     */
    getWindowPositionUsingStrategy(windowPositioningOptions?: WindowPositioningOptions,
