		...
		const customSearchResult: HomeSearchResult = {
			...
			templateContent: {
				...
				data: {
					...
					imageSrcId:
						"https://built-on-openfin.github.io/workspace-starter/workspace/v20.1.0/workspace-platform-starter/common/images/ms/apps/outlook-calendar.svg",
					textContent: "This is text content",
					imageContent: "https://cdn.openfin.co/workspace/20.1.3/icons/defaultFavicon.svg",
					listContent: [
						["Label 1", "Value 1"],
						["Label 2", "Value 2"]
					],
