...
- Added example of supporting workspace and desktop browser (through openfin/core-web as part of HERE anywhere) to our contact and manager portal examples in public/common by importing the fin/fdc3 api if it is not available (will require being rendered in an HERE Web Layout: <https://github.com/built-on-openfin/web-starter/tree/web/v46.0.0>).
