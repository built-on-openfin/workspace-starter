...
A HERE Core UI Platform can define a set of contextual groups (system channels). You can default to unassigned and let the end user assign your app to a group or you can default yourself to one of them:
...
HERE Core UI Platform Starter supports the fdc3 preference of including app metadata alongside the context. You can check to see if you are the sender through a snippet like this:
...
It is useful to be able to test your app against something. When you reference the common apps feed in your instance of HERE Core UI Platform starter you get a number of useful utilities. We provide two entries related to context sharing in FDC3:
...
```javascript
{
    "url": "https://samples.openfin.co/dev-extensions/extensions/v23.2.0/interop/fdc3/context/2-0/fdc3-broadcast-view.html",
    "fdc3InteropApi": "2.0",
    "customData": {
        "contextData": null,
        "customChannel": ""
...
```javascript
{
    "url": "https://samples.openfin.co/dev-extensions/extensions/v23.2.0/interop/fdc3/context/fdc3-broadcast-view.html",
    "fdc3InteropApi": "2.0",
    "customData": {
        "contextData": null,
        "customChannel": ""
