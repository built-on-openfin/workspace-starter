  ...
  "applications": [
    {
      ...
      "manifest": "https://built-on-openfin.github.io/workspace-starter/workspace/v19.2.0/common/views/fdc3/workbench/fdc3-workbench.view.fin.json",
      "manifestType": "view",
      "icons": [
        {
      ...
      "images": [
        {
          "url": "https://built-on-openfin.github.io/workspace-starter/workspace/v19.2.0/common/images/previews/fdc3-workbench.png"
        }
      ]
    }
  ]
