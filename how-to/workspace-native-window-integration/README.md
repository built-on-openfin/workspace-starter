...
* Launch the Github hosted version of this sample to interact with it by going to the following link: <a href="https://start.openfin.co/?manifest=https%3A%2F%2Fbuilt-on-openfin.github.io%2Fworkspace-starter%2Fworkspace%2Fv6.0.0%2Fworkspace-native-window-integration%2Fmanifest.fin.json" target="_blank">Github Workspace Starter Customize Workspace Example</a>
...
5. Show Home after registration.
6. Listen for when your workspace platform is about to close and deregister from home. 
