...
2. Optional (if you wish to pin the version of HERE Core UI to version 45.2.2 and you are on Windows) - Set Windows registry key for [Desktop Owner Settings](https://resources.here.io/docs/core/manage/desktops/dos/).
