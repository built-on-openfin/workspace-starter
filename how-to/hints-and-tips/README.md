![HERE Core UI](../../assets/HERO-STARTER-HERE-CORE-UI.png)
...
| [FDC3 App Channel API](./docs/window-level-app-channel.md)                              | This document covers an example of how you can use HERE and FDC3 APIs to have a window level app channel that updates as your views are moved from one window to another.                                                                        |
...
| [Version Info](./docs/version-info.md)                                                  | This document covers how you can look up information related to your application, the rvm, the runtime or the HERE Core UI Components.        |
...
| [Protocol Links](./docs/protocol-support.md)                                            | This document covers how you can configure protocol support for your HERE platform e.g. mailto:, msteams: etc.                          |
