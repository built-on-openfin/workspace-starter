 ...
 */
export declare type SalesforceAccount = SalesforceRestApiSObject<{
    Industry?: string;
    Name: string;
    Phone?: string;
    Type?: string;
 ...
 */
export declare type SalesforceContact = SalesforceRestApiSObject<{
    Department?: string;
    Email: string;
    Name: string;
    Phone?: string;
 ...
 */
export declare type SalesforceTask = SalesforceRestApiSObject<{
    Subject?: string;
    Description?: string;
}>;
/**
 ...
 */
export declare type SalesforceContentNote = SalesforceRestApiSObject<{
    Title?: string;
    TextPreview?: string;
}>;
/**
