...
| sharing                                                        | Should we enable sharing features in the platform                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| globalMenu[i].conditions                                       | Additional conditions to check before displaying the entry                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| pageMenu[i].separator                                          | Display a separator adjacent to the menu item [before, after]                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| enablePageIntegration                                          | Default is true. Enable our default page integration in home so that you can discover, launch and delete pages from home. Disable if you want to plug in your own implementation using the integration provider.                                                                                                                                                                                                                                                              |
...
| modules.item.url                                               | The url of the module to load                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| modules.item.data                                              | Any custom settings for the module                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **headlessProvider**                                           | Config related to launching of headless logic. If you wish to spin up a headless window after authentication (if required). You can use this to launch and configure a hidden window to run specific logic (e.g. acting as a notification agent or something else)                                                                                                                                                                                                            |
| modules                                                        | An array of modules that point to pages you wish to launch and the id to give them.                                                                                                                                                                                                                                                                                                                                                                                           |
| modules.entry.id                                               | The identity/name to give the launched window.                                                                                                                                                                                                                                                                                                                                                                                                                                |
| modules.entry.url                                              | The url to launch.                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| modules.entry.enabled                                          | Default true. Is this entry enabled and should it be launched.                                                                                                                                                                                                                                                                                                                                                                                                                |
| modules.entry.data                                             | The option of specifying custom window options to override or enrich default settings or pass customData (if your window uses it).                                                                                                                                                                                                                                                                                                                                            |
