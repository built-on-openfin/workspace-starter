...
We have a manifest (see [third.manifest.fin.json](../public/third.manifest.json) that has been configured to use this module and provide you with a workspace that imports an FDC3 App Directory (see [apps-fdc3-1-2.json](../public/apps-fdc3-1-2.json)).
