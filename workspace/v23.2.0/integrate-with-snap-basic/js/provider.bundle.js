 ...
 */
async function prefetchAppAsset(primaryUrl, fallbackUrl) {
    const snapAssetInfo = {
        alias: snapAlias,
        src: snapDefaultUrl,
        version: snapVersion,
    ...
    if (validatedAssetUrl) {
        logInformation(`Successfully validated the url for the snap asset: ${validatedAssetUrl}. Downloading snap asset with the validated url.`);
