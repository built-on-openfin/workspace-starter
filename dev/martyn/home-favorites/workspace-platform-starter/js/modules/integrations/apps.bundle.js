...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'workspace-platform-starter/shapes/favorite-shapes'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _framework_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../framework/utils */ "./client/src/framework/utils.ts");
...
class AppProvider {
                    ...
                    if (favClient) {
                        ...
                        if (favInfo) {
                            ...
                            if (result.action.name.startsWith("un")) {
                                if (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(favoriteId) && favClient.deleteSavedFavorite) {
                                    await favClient.deleteSavedFavorite(favoriteId);
                                    favoriteId = undefined;
                                }
                            }
                            else if (favClient.setSavedFavorite) {
                                favoriteId = (0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.randomUUID)();
                                await favClient.setSavedFavorite({
                                    id: (0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.randomUUID)(),
                                    type: Object(function webpackMissingModule() { var e = new Error("Cannot find module 'workspace-platform-starter/shapes/favorite-shapes'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
                                    typeId: result.key,
                                    label: result.title,
                                    icon: result.icon
                                });
                            ...
                            if (this._lastQuery === favInfo.command && (0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(favoriteId)) {
        ...
        if (this._integrationHelpers?.getApps) {
            ...
            if ((this._definition?.data?.favoritesEnabled ?? true) && this._integrationHelpers.getFavoriteClient) {
                ...
                if (favClient) {
                    ...
                    if (info.isEnabled && (0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isStringValue)(info.command)) {
                        const isSupported = (0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(info.enabledTypes) || info.enabledTypes.includes(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'workspace-platform-starter/shapes/favorite-shapes'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
                        if (isSupported && queryLower === info.command) {
                            const favoriteApps = await favClient.getSavedFavorites(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'workspace-platform-starter/shapes/favorite-shapes'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
                    ...
                    if (matchQuery.length >= options.queryMinLength || isCommand) {
                        textMatchFound = options.queryAgainst.some((target) => {
                            ...
                            if (path.length === 1) {
                                ...
                                if ((0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isStringValue)(targetValue)) {
                                ...
                                if ((0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isObject)(specifiedTarget)) {
                                    let targetValue;
                                    if (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(specifiedTarget)) {
                                    ...
                                    if (Array.isArray(targetValue)) {
                                        if (targetValue.length > 0 &&
                                            (0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isStringValue)(targetValue[0]) &&
                    ...
                    if (tagFilters.length > 0) {
                        filterMatchFound = tagFilters.some((filter) => {
                            if (Array.isArray(filter.options)) {
                                if (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(entry.data?.app?.tags)) {
                                    return filter.options.every((option) => !option.isSelected || entry.data.app.tags.includes(option.value));
                                }
                            }
                            else if (filter.options.isSelected && !(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(entry.data?.app?.tags)) {
            ...
            if ((this._definition?.data?.favoritesEnabled ?? true) && this._integrationHelpers?.getFavoriteClient) {
                ...
                if (favClient) {
                    ...
                    if (favInfo.isEnabled) {
                        const isSupported = (0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(favInfo.enabledTypes) || favInfo.enabledTypes.includes(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'workspace-platform-starter/shapes/favorite-shapes'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
                        if (isSupported) {
                            savedFavorites = await favClient.getSavedFavorites(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'workspace-platform-starter/shapes/favorite-shapes'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
                        }
                        else {
                            favInfo = undefined;
                        }
    ...
    async mapAppEntryToSearchEntry(app, typeMapping, favInfo, favoriteId, colorScheme) {
        ...
        if ((0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isStringValue)(manifestType)) {
            ...
            if (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(typeMapping)) {
                const manifestTypeMapping = typeMapping[manifestType];
                if (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(manifestTypeMapping)) {
                    if ((0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isStringValue)(manifestTypeMapping.entryLabel)) {
                        entry.label = manifestTypeMapping.entryLabel;
                    }
                    if ((0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isStringValue)(manifestTypeMapping.actionName)) {
            ...
            if (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(app.description)) {
                entry.description = app.description;
                entry.shortDescription = app.description;
            }
            const headerButtons = [];
            if (favInfo?.favoriteIcon && favInfo.unfavoriteIcon) {
                const icon = (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(favoriteId) ? favInfo.favoriteIcon : favInfo.unfavoriteIcon).replace("{scheme}", colorScheme);
                headerButtons.push({
                    icon,
                    action: !(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(favoriteId) ? "unfavorite" : "favorite"
                });
            }
    ...
    async rebuildResults() {
        if (!(0,_framework_utils__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(this._lastResponse) &&
